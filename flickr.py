...
API_KEY = 'a39dfdf51784c76fa3234f88bec38b0e'
API_SECRET = 'b6300e9ef4c1a5f9'
email = None
password = None
AUTH = False
debug = False
...
def getUserNSID(username):
	method = 'flickr.urls.lookupUser'
	data = _doget(method, url='http://www.flickr.com/photos/' + username)
	return data.rsp.user.id
